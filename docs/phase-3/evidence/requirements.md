...
Repository matrices: [FUN](https://github.com/rafaelxvr/Tech-challenge-15SOAT-functions/blob/dbceabcf3dd9d11597af98825c3ca54159cbbf4f/docs/evidence/requirements.md), [K8S](https://github.com/rafaelxvr/Tech-challenge-15SOAT-k8s-infra/blob/22d60af8964f08844517c6768cf38323c27ee3d7/docs/evidence/requirements.md), [DB](https://github.com/rafaelxvr/Tech-challenge-15SOAT-db-infra/blob/33b7da9172c45d766d36e7561d59ee289053b02b/docs/evidence/requirements.md). Audited source baselines: APP `b4b1e8f`, FUN `471d072`, K8S `47fb380`, DB `ed7f5df`. These are local commits, not cloud receipts.
