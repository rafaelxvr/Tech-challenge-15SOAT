...
The merged FUN push workflow run [35315358633](https://github.com/rafaelxvr/Tech-challenge-15SOAT-functions/actions/runs/35315358633) and K8S push workflow run [35313930756](https://github.com/rafaelxvr/Tech-challenge-15SOAT-k8s-infra/actions/runs/35313930756) reached their deployment guards and failed closed because the approved cloud window was closed; neither attempted a deployment. These checks are source and contract evidence only. They did not call AWS, OIDC, CodeBuild, Terraform apply, Kubernetes APIs, external URLs, video hosting or the student portal.
