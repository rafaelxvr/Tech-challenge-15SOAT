...
Edges to DynamoDB represent event/order correlation only, never PostgreSQL foreign keys. Actor constraints distinguish STAFF, CUSTOMER, SYSTEM and LEGACY_UNKNOWN; legacy timestamps/sequences are not fabricated. See [ADR 005](../../adrs/005-canonical-reporting.md) and [RFC 002](../../rfcs/002-postgresql-model.md).
