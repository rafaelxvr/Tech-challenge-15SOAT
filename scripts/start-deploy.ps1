...
if ($SourcePrefix -cne "releases/app/$Environment" -or $ProjectName -cne "oficina-phase3-oficina-app-$Environment-deploy") { throw 'Unreviewed application launcher target.' }
...
throw 'APP_DEPLOYMENT_DISABLED: cloud activation, versioned artifact promotion, APP migration/rollout orchestration and platform executor wiring are not installed. No upload or CodeBuild start was attempted.'
